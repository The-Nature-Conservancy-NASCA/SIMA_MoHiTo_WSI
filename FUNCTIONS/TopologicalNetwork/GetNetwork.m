function [PoPo, PoPo_i] = GetNetwork( ArcID, Arc_InitNode, Arc_EndNode, ArcID_Downstream, PoPo, PoPo_i)
% -------------------------------------------------------------------------
...
while NumberBranches == 1
    ...
    if NumberBranches > 1           
        for i = 1:NumberBranches 
            ...
            [PoPo, PoPo_i]   = GetNetwork( ArcID, Arc_InitNode, Arc_EndNode, start_sub_id, PoPo, PoPo_i);
